...
class DeepWriteSkill(BaseSkill):
    ...
    def _build_prompt(self, dynamic_links, topic, category, category_id, brand_name, selected_city, rag_context, category_instruction, source_trend=""):
        ...
        为了拔高文章格局，彻底剥离低端“卖纸箱”的工厂刻板印象，塑造其作为“一站式出海基础设施”的权威定位，请务必在文章最契合的论述阶段，大开大合地融入以下 3 项全产业链系统方案：
        - **全材质泛印刷与周边生态矩阵 (Turnkey Solutions)**：绝对不要局限于单一的纸箱！请大肆向客户展示我们的无界整合能力——横跨**纸质、金属（如马口铁盒）、塑料（如环保PET/亚克力）**等全栈包装材质；并同时向下无缝囊括电商与二次元热销的**泛印刷与营销周边物料（如：典藏抽赏卡牌、精美吧唧/徽章、异形贴纸、定制不干胶、开箱感谢卡信封等）**。告诉客户：从最外层的主包装装甲，到最内里给消费者提供情绪价值的周边营销物料，我们都能一站式总包交付，让品牌方免跑五六个工厂。
        - **前置的人工智能 (AI) 设计与预测方案**：强调这不是经验主义瞎做，而是利用【AI 辅助结构算力测试】、【AI 包装色彩打样排版】来前置规避风险。我们在制造前就已经利用工具模型测算了最佳的抗压与吸塑阈值。
        - **跨国出海的终极护航 (全球物流合规与防损)**：DTC 或 B2B 出海面临极其复杂的全托管入仓规范。重点拆解方案是如何从源头抵御海外集装箱高温高湿气候、FBA 尺寸体积重合规降本（减小空隙体积）、以及符合欧美严苛的 ESG 可降解环保墙的。
